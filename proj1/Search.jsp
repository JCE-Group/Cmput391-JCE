...
<html>
    <head>
		...
		<center>
			<form action = Search2.jsp>
				Min date: <input type = "date" value = 1900-01-01 name = "minDate" > 
				Max date: <input type = "date" value = 2016-12-31 name = "maxDate" >
	...
	try{
		...
		String sql = "SELECT * FROM images i WHERE (i.permitted = 1";
